            ...
            request(protocolRequest, function (error, result, body) {
                request(protocolRequest2, function (error, result, body) {
                    request(listRequest, function (error, result, body) {
                        should.not.exist(error);
                        should.exist(body);
                        body.protocols[0].description.should.equal('A generic protocol updated with new information');

                        body.protocols[0].iotagent.should.equal('http://smartGondor.com/New');
