...
function processEnvironmentVariables() {
    ...
    const mongoVariables = [
        'IOTA_MONGO_URI',
        'IOTA_MONGO_HOST', // FIXME: to be removed (deprecated)
        'IOTA_MONGO_PORT',  // FIXME: to be removed (deprecated)
        'IOTA_MONGO_DB',  // FIXME: to be removed (deprecated)
        'IOTA_MONGO_REPLICASET',  // FIXME: to be removed (deprecated)
        'IOTA_MONGO_RETRIES',  // FIXME: to be removed (deprecated)
        'IOTA_MONGO_RETRY_TIME'  // FIXME: to be removed (deprecated)
    ];
