...
module.exports = {
    ...
    DuplicateError: function(error_response) {
        this.name = error_response['name'];
        this.message = error_response['message'];
        this.code = 409;
        // Expect IOTAM CPP format: errors[{ endpoint, code, details { name, mesage} }]
        this.errors = [{"code": this.code, "details": error_response}];
    }
};
