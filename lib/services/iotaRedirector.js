 ...
 *
 * @param req {Object}          Original request object to be forwarded.
 * @param protocol {String}     ID of the protocl where the request will be forwarded
 * @param body {Object}         JSON body of the original request.
 * @returns {Object}            Request object prepared to be sent.
 */
        ...
        request(options, function(error, response, body) {
            if (error) {
                ...
                callback(new errors.TargetServerError(
                    'Wrong status code detected [' + response.statusCode + '] and body response [' +\
                    response.body + '] redirecting request'));
